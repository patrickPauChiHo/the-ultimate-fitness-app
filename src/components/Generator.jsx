...
function Generator(props) {
  ...
  const { muscle, setMuscle, poison, setPoison, goal, setGoal, updateWorkout } =
    props;
  ...
  function updateMuscles(muscleGroup) {
    if (muscle.includes(muscleGroup)) {
      setMuscle(muscle.filter((muscle) => muscle !== muscleGroup));
      return;
    }
    ...
    >
      ...
      <div className="bg-slate-950 border border-solid border-blue-400 rounded-lg flex flex-col">
        ...
        >
          ...
          <i
            className="fa-solid absolute right-3 top-1/2 
          -translate-y-1/2 fa-caret-down"
          ></i>
        </button>
        {showModal && (
